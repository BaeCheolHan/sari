...
def _build_core_fields(*, file_config: dict[str, object], defaults: type[AppConfig]) -> tuple[_ConfigField, ...]:
    ...
    return (
        ...
        _ConfigField("lsp_max_per_repo_lang_raw", "SARI_LSP_MAX_INSTANCES_PER_REPO_LANGUAGE", "lsp_max_instances_per_repo_language", 1),
        _ConfigField("lsp_bulk_max_per_repo_lang_raw", "SARI_LSP_BULK_MAX_INSTANCES_PER_REPO_LANGUAGE", "lsp_bulk_max_instances_per_repo_language", 2),
        ...
        _ConfigField("lsp_global_soft_limit_raw", "SARI_LSP_GLOBAL_SOFT_LIMIT", "lsp_global_soft_limit", 16),
