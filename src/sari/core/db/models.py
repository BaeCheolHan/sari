...
class Symbol(BaseModel):
    # Important: sari's actual schema uses a composite PK (root_id, path, name, line)
    # We must not let peewee assume a default 'id' column.
...
class SymbolRelation(BaseModel):
    ...
    class Meta:
        ...
        # Composite unique constraint from schema
        indexes = (
...
class Context(BaseModel):
    id = AutoField() # Many context tables use internal rowid
