...
class Scanner:
    def __init__(self, cfg, active_workspaces: Optional[List[str]] = None):
        ...
        self.exclude_glob_regex = self._compile_patterns(
            user_exclude_globs | self.hard_exclude_globs)
    ...
    def _compile_patterns(self,
                          patterns: Iterable[str]) -> Optional[re.Pattern]:
    ...
    def _scan_recursive(self,
                        ...
                        apply_exclude: bool,
                        visited: set) -> Iterable[Tuple[Path,
                                                        os.stat_result,
                                                        bool]]:
        ...
        if current_dir != root:
            if self.workspace_trie.is_path_owned_by_sub_workspace(
                    str(current_dir), str(root)):
                return
