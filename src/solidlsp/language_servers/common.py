...
class RuntimeDependencyCollection:
    ...
    def __init__(self, dependencies: Sequence[RuntimeDependency], overrides: Iterable[Mapping[str, object]] = ()) -> None:
        ...
        for dep_values_override in overrides:
            ...
            if base_dep is None:
                new_runtime_dep = RuntimeDependency(**cast(dict[str, object], dep_values_override))
