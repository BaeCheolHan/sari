...
class ElixirTools(SolidLanguageServer):
    ...
    def _start_server(self) -> None:
        ...
        def window_log_message(msg: dict[str, object]) -> None:
        ...
        def check_server_ready(params: dict[str, object]) -> None:
            """
        ...
        def work_done_progress_create(params: dict[str, object]) -> None:
            """Handle window/workDoneProgress/create requests from Expert."""
            return

        def publish_diagnostics(params: dict[str, object]) -> None:
